...
def export_to_onnx(
    ...
    if pegasus:
        print("Loading Pegasus model checkpoint...")
        ...
        print("Pegasus model checkpoint loaded")

    else:
        print("Loading Bart model checkpoint...")
        model = BartForConditionalGeneration.from_pretrained(model_checkpoint)
        model_config = BartConfig.from_pretrained(model_checkpoint)
        print("Bart model checkpoint loaded")
...
if __name__ == '__main__':
    ...
    pegasus_onnx_paths = export_to_onnx(pegasus_checkpoint, output_path=output_path)
    bart_onnx_paths = export_to_onnx(bart_checkpoint, output_path=output_path, pegasus=False)
